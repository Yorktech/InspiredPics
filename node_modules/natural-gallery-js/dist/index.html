...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/73d7e3263431cec5d968880fa5de864f.css">
        <link rel="stylesheet" href="/edc8d469fbeff2b174295da70978499f.css">
        <script src="/1ded2977b993a4959634bbdc4937a7e3.js"></script>

        <!-- Demo assets -->
        <link href="https://fonts.googleapis.com/css?family=PT+Sans:400,400italic,700italic,700" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="/5431258a52a9483387ef8da3f71a48ff.css">
        <link rel="stylesheet" href="/1577a0853926e324d5ba048d7ec97ac4.css">
    ...
    <body>
        <div class="container">
            ...
            <h1>Natural gallery</h1>
            <h2 class="text-center">lightbox, no link</h2>

            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 100 100" xml:space="preserve" style="display:none;">

                <g id="icon-select">
                    <path d="M50,0C22.4,0,0,22.4,0,50c0,27.6,22.4,50,50,50c27.6,0,50-22.4,50-50C100,22.4,77.6,0,50,0z M40,75L15,50l7.1-7.1L40,60.8l37.9-37.9L85,30L40,75z"></path>
                </g>
                <g id="icon-search">
                    <path d="M67.647,61.054c1.74-1.741,3.046-3.706,3.916-5.896c0.87-2.19,1.305-4.422,1.305-6.696c0-2.274-0.435-4.52-1.305-6.738
                        ...
                        c4.099,0,8.128,0.786,12.086,2.358C71.058,20.261,74.61,22.591,77.754,25.679z"></path>
                </g>
                <g id="icon-next">
                    <polygon points="88.126,24.216 50.036,62.306 11.947,24.216 0.355,35.809 50.036,85.49 99.718,35.809 		"></polygon>
                </g>
                <g id="icon-category">
                    <path d="M98.929,28.421L87.854,17.346c-1.311-1.311-3.436-1.311-4.747,0L36.974,63.48L17.353,43.859
                        ...
                        C99.912,29.904,99.559,29.05,98.929,28.421z"></path>
                </g>
                <g id="icon-pict">
                ...
                <g id="icon-noresults">
                    <path d="M99.912,6.908L6.821,100l-5.812-5.812L94.1,1.096L99.912,6.908z M68.442,8.462L5.237,71.349V8.462H68.442z M35.174,27.716
                        ...
                        c-0.846,0-2.921,0-8.254,0l-9.896,9.847h63.07V29.881L73.257,52.198C78.41,62.531,88.123,82.004,88.514,82.787z"></path>
                </g>
            </svg>
        ...
        <script type="text/javascript">
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    ...
                    gallery.collection = JSON.parse(xhr.responseText);
                }
            };
